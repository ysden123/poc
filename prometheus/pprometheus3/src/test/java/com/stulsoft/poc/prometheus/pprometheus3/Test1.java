...
public class Test1 {
	...
	public static void setUp() throws IOException {
		...
		testCounter = Counter
				...
				.labelNames("my_label_names", "another_label_names")
				.register(registry);
	}
	...
	public void testForCounter() {
		...
		testCounter.labels("my_label_names", "label_1").inc();
		testCounter.labels("another_label_names","label_2").inc(2);
		testCounter.labels("attempt_2","label_3").inc(3);
		try {
			showMetrics();
		} catch (Exception e) {
			fail(e.getMessage());
